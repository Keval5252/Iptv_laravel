        ...
        <div class="space-y-6">
            <div class="rounded-lg">
                ...
                <p class="text-gray-800 mb-2">
                    Go to: <span class="font-semibold">Settings → Configuration → System → Network → Device Configuration → Adapter Settings</span>
                </p>
                <p class="text-gray-800">
                    Get your IP address (starts with 192.168...)
                </p>
                <img src="https://cdn.shopify.com/s/files/1/0572/0116/4425/files/en1_480x480.png?v=1650631464" alt="Network Settings" class="my-4 rounded border border-gray-300">
            </div>
            ...
            <div class="rounded-lg">
                ...
                <p class="text-gray-800">
                    Putty Download URL:
                    <a href="https://the.earth.li/~sgtatham/putty/latest/x86/putty.exe" class="text-blue-600 hover:underline" target="_blank">
                        https://the.earth.li/~sgtatham/putty/latest/x86/putty.exe
                    </a>
                </p>
                <img src="https://cdn.shopify.com/s/files/1/0572/0116/4425/files/en2_480x480.png?v=1650631498" alt="Putty Download" class="my-4 rounded border border-gray-300">
            </div>
            ...
            <div class="rounded-lg">
                ...
                <img src="https://cdn.shopify.com/s/files/1/0572/0116/4425/files/en3_480x480.png?v=1650631581" alt="Putty Configuration" class="my-4 rounded border border-gray-300">
            </div>
            ...
            <div class="rounded-lg">
                ...
                <img src="https://cdn.shopify.com/s/files/1/0572/0116/4425/files/en4_480x480.png?v=1650631613" alt="Telnet Login" class="my-4 rounded border border-gray-300">
            </div>
            ...
            <div class="rounded-lg">
                ...
                <img src="https://cdn.shopify.com/s/files/1/0572/0116/4425/files/en5_480x480.png?v=1650631641" alt="Reboot Command" class="my-4 rounded border border-gray-300">
            </div>
