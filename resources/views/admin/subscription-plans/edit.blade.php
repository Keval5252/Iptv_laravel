        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        <i class="fa fa-edit mr-2"></i>Edit Subscription Plan: {{ $subscriptionPlan->name }}
                    </h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" 
                                        ...
                                        <option value="" disabled {{ old('type', $subscriptionPlan->type) == '' ? 'selected' : '' }}>Select Plan Type</option>
                                        <option value="monthly" {{ old('type', $subscriptionPlan->type) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                        <option value="yearly" {{ old('type', $subscriptionPlan->type) == 'yearly' ? 'selected' : '' }}>Yearly</option>
                                        <option value="lifetime" {{ old('type', $subscriptionPlan->type) == 'lifetime' ? 'selected' : '' }}>Lifetime</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('duration') is-invalid @enderror" 
                                           id="duration" name="duration" value="{{ old('duration', $subscriptionPlan->duration) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" 
                                           id="price" name="price" value="{{ old('price', $subscriptionPlan->price) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('original_price') is-invalid @enderror" 
                                           id="original_price" name="original_price" value="{{ old('original_price', $subscriptionPlan->original_price) }}" 
                                           placeholder="0.00">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="display_home" name="display_pages[]" 
                                               value="home" {{ in_array('home', old('display_pages', $subscriptionPlan->display_pages ?? [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="display_iptv_subscription" name="display_pages[]" 
                                               value="iptv-subscription" {{ in_array('iptv-subscription', old('display_pages', $subscriptionPlan->display_pages ?? [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="display_adult_iptv" name="display_pages[]" 
                                               value="adult-channel" {{ in_array('adult-channel', old('display_pages', $subscriptionPlan->display_pages ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="display_adult_iptv_multi" name="display_pages[]" 
                                               value="multi-connections" {{ in_array('multi-connections', old('display_pages', $subscriptionPlan->display_pages ?? [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="display_multi_connections" name="display_pages[]" 
                                               value="multi-connections-prices" {{ in_array('multi-connections-prices', old('display_pages', $subscriptionPlan->display_pages ?? [])) ? 'checked' : '' }}>
