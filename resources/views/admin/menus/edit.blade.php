        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        <i class="fa fa-edit mr-2"></i>Edit Menu: {{ $menu->name }}
                    </h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control @error('location') is-invalid @enderror" 
                                            ...
                                            <option value="drawer" {{ old('location', $menu->location) == 'drawer' ? 'selected' : '' }}>Mobile Drawer</option>
                                            <option value="operation_guide" {{ old('location', $menu->location) == 'operation_guide' ? 'selected' : '' }}>Operation Guide</option>
                                            <option value="subscription" {{ old('location', $menu->location) == 'subscription' ? 'selected' : '' }}>Subscription Plans</option>
                                ...
                                <div class="mb-3" id="customLocationDiv" style="display: none;">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('custom_location') is-invalid @enderror" 
                                               ...
                                               value="{{ old('custom_location', $menu->location) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Enter menu description (optional)">{{ old('description', $menu->description) }}</textarea>
                                    </div>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
