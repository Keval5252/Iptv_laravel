        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        <i class="fa fa-edit mr-2"></i>Edit Menu Item: {{ $menuItem->title }}
                    </h4>
                </div>
                <div class="card-body">
                    @if($errors->any())
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                               id="title" name="title" value="{{ old('title', $menuItem->title) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('route_name') is-invalid @enderror" 
                                               id="route_name" name="route_name" value="{{ old('route_name', $menuItem->route_name) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('url') is-invalid @enderror" 
                                               id="url" name="url" value="{{ old('url', $menuItem->url) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control @error('target') is-invalid @enderror" 
                                            ...
                                            <option value="_parent" {{ old('target', $menuItem->target) == '_parent' ? 'selected' : '' }}>Parent Frame</option>
                                            <option value="_top" {{ old('target', $menuItem->target) == '_top' ? 'selected' : '' }}>Top Frame</option>
                                        </select>
                                    </div>
                                    @error('target')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="plan_type_iptv" 
                                                       name="plan_types[]" value="iptv" {{ in_array('iptv', old('plan_types', $menuItem->plan_types ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="plan_type_adult" 
                                                       name="plan_types[]" value="adult" {{ in_array('adult', old('plan_types', $menuItem->plan_types ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="plan_type_adult_multi" 
                                                       name="plan_types[]" value="adult_multi" {{ in_array('adult_multi', old('plan_types', $menuItem->plan_types ?? [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="plan_type_multi" 
                                                       name="plan_types[]" value="multi" {{ in_array('multi', old('plan_types', $menuItem->plan_types ?? [])) ? 'checked' : '' }}>
