...
<head>
    ...
    <title>User Login - IPTV Service</title>
                ...
                <div class="card login-card">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted">Sign in to your IPTV account</p>
                        </div>
                        ...
                        <div class="text-center mb-4">
                            <div class="border-top pt-4">
                                ...
                                <a href="{{ route('user.register') }}" class="btn btn-outline-primary btn-lg w-100">
